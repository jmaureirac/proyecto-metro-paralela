...
int main(int argc, char** argv) {
    ...
    if ( argc <= 2 ) {
        ...
        if(strcmp(flag,"-f") == 0){
            ...
            recorrido ruta_c = (recorrido) malloc(sizeof(ruta));
            stack_rutas = buscarRuta(estacion_inicial,estacion_destino, l1, l2, l4, l4a, l5, l6);
            // rutaMasCorta(estacion_inicial,estacion_destino, &ruta_c);
